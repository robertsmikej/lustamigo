...
:root {
    ...
    --dark-grey: #40270F;
    --light-grey: #f2f2f2;
    --question-color: #508844;

    --main-font: 'Neucha', 'Source Sans Pro', -apple-system, BlinkMacSystemFont, 'Segoe UI',
...
.answer__cell__inner .question__answer__cell {
    flex: 0 1 310px;
}
...
.question__answer__partner__cell input[type="radio"] {
    display: block;
}
